...
function Icon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16">
      ...
      <g id="LocationsEdit" fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
        <g id="AssetsEdit" transform="translate(-28 -27)">
          <g id="Edit2" transform="translate(28 27)">
            <mask id="mask-2-edit2" fill="#fff">
              <use xlinkHref="#path-1-edit2" />
            </mask>
            <use id="ShapeEdit" fill="#FFF" xlinkHref="#path-1-edit2" />
            <g id="GroupEdit" fill="#001122" mask="url(#mask-2-edit2)">
              <g id="🎨-ColorEdit">
                <path id="Rectangle-2222" d="M0 0H16V16H0z" />
              </g>
            </g>
          </g>
        </g>
